export const seedData = {
  ...
  nutrient_types: [
    { name: 'Protein', icon: '🥩', color: '#ef4444', description: 'Meat, seafood, eggs, legumes, dairy' },
    { name: 'Carbohydrate', icon: '🌾', color: '#f59e0b', description: 'Grains, pasta, bread, rice, sugar' },
    { name: 'Fat & Oil', icon: '🫒', color: '#22c55e', description: 'Oils, butter, nuts, cheese' },
    { name: 'Fiber & Produce', icon: '🥬', color: '#10b981', description: 'Vegetables, fruits, leafy greens' },
    { name: 'Seasoning', icon: '🧂', color: '#8b5cf6', description: 'Spices, herbs, salt, pepper' },
    { name: 'Condiment', icon: '🍶', color: '#06b6d4', description: 'Sauces, vinegar, ketchup, mustard' },
    { name: 'Beverage', icon: '☕', color: '#64748b', description: 'Coffee, tea, juice' },
    { name: 'Other', icon: '📦', color: '#94a3b8', description: 'Snacks, frozen prepared foods' },
  ],
  categories: [
    { name: 'Produce', nutrient_type: 'Fiber & Produce' },
    { name: 'Meat & Seafood', nutrient_type: 'Protein' },
    { name: 'Dairy & Eggs', nutrient_type: 'Protein' },
    { name: 'Bakery & Grains', nutrient_type: 'Carbohydrate' },
    { name: 'Pantry Staples', nutrient_type: 'Carbohydrate' },
    { name: 'Canned Goods', nutrient_type: 'Protein' },
    { name: 'Oils & Condiments', nutrient_type: 'Condiment' },
    { name: 'Spices & Seasonings', nutrient_type: 'Seasoning' },
    { name: 'Snacks', nutrient_type: 'Other' },
    { name: 'Frozen Foods', nutrient_type: 'Other' },
    { name: 'Beverages', nutrient_type: 'Beverage' },
    { name: 'Breakfast', nutrient_type: 'Carbohydrate' },
    { name: 'Ready-to-Eat', nutrient_type: 'Other' },
