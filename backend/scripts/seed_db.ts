  ...
  try {
    ...
    try {
      ...
      if (isProduction) {
        ...
        console.log('🛠️ Development environment detected. Seeding sample inventory and recipes...');
        ...
        // Insert Pantry Ingredient Items
...
/**
 * Seeds essential system reference data without user data.
 */
